...
The code referred to here can be found at the following
source repository: `<https://github.com/palmerlab/behaviour_box>`_.
The easiest way to get this code is to follow the link and select
the **Clone or download** button. The recommended way is to install
git-svn, (`a Windows installer can be found 
here  <https://git-scm.com/download/win>`__) and to use the command::

    >> git clone https://github.com/palmerlab/behaviour_box
    
This will allow you to easily stay up to date with any future changes, 
if you choose.
...
.. note::
    This system was written using python 2.7 on Windows 7. 
